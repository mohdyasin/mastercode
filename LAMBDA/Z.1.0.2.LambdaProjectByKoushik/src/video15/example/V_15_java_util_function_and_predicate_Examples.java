...
public class V_15_java_util_function_and_predicate_Examples {
	...
	private static void printConditionally(List<Person> people, Predicate<Person> person) {
		for (Person p : people) {
			if (person.test(p)) {
