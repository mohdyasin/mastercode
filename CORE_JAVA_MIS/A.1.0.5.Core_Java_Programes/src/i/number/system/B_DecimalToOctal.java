...
public class B_DecimalToOctal {
	...
	public static void main(String args[]) {
		...
		/*
		 * Method 1: Using predefined method toOctalString(int) Pass the decimal
		 * number to this method and it would return the equivalent octal number
		 */
		String octalString = Integer.toOctalString(num);
		System.out.println("Method 1: Decimal to octal: " + octalString);

		/*
		 * Method 2: Writing your own logic: Here we will write our own logic
