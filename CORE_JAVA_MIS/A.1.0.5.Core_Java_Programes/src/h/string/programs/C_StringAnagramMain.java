...
public class C_StringAnagramMain {
	...
	public static boolean isAnagramUsingStringMethods(String word, String anagram) {
		...
		for (int i = 0; i < word.length(); i++) {
			...
			// If index of any character is -1, then two strings are not
			// anagrams
			// If index of character is not equal to -1, then remove the chacter
			// from the String
			if (index != -1) {
